                ...
                if(resData.err === 0) {
                    ...
                    */
                    if (window.cordova) {
                        ...
                        $rootScope.userDB = $cordovaSQLite.openDB({ name: "mmx_" + data.accID,location: 1});
                        alert(Object.keys($rootScope.userDB));
                        console.log('dbname,' + $rootScope.userDB.dbname);
                        ...
                        $rootScope.userDB.transaction(function(tx) {
                            console.log('tx...' + Object.keys(tx.db));
                            ...
                            .then(function(res) {
                                ...
                                console.log('will CREATE new table');
